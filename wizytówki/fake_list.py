...
info_card = [
    ...
    BaseContact("Brygida","Zając","Sure Save","Long haul truck driver","BrygidaZajac@armyspy.com"),
    BaseContact("Walenty","Kaczmarek","Quality Realty Service","Radar controller","WalentyKaczmarek@armyspy.com"),
    BaseContact("Stefania","Symanska","Star Merchant Services","Health education specialist","StefaniaSymanska@teleworm.us"),
    BaseContact("Gerwazy","Pawlak","Pender's Food Stores","Farmworker","GerwazyPawlak@teleworm.us"),
]
